// 所有 pass 共用的全屏顶点 shader:顺带算好上下左右邻居的 uv
...
// 喷溅:高斯笔刷,把 color 叠加进目标场(velocity 或 dye)
...
// 平流:沿速度回溯采样;末尾乘 dissipation = 逐帧衰减(对齐 0.97/0.98)
